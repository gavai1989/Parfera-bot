...
# Generic Russian PDM Wordstat spellings that are not safe to encode as exact
# aliases are normalized by the phonetic name layer below. These brand forms let
# the normal search parse «парфюм де марли альтаир» as PDM + ALTHAIR.
BRAND_QUERY_ALIASES.update({
